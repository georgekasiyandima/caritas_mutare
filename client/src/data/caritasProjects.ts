/**
 * Canonical list of Caritas Mutare projects (donor-funded and own initiatives).
 * Source: Website Information CARITAS Mutare, PROJECTS 2, PROJECTS3.
 * This is the single source of truth for project content; UI derives from here.
 */

import type { CaritasProject } from './types';
...
export const caritasProjects: CaritasProject[] = [
  {
    ...
    galleryImages: [
      ...
      '/images/programs/serarp/community-poster-oak.png',
    ],
    status: 'active',
    icon: 'Agriculture',
    color: 'success.main',
  ...
  },
  {
    ...
    galleryImages: [
      '/images/programs/didrr/disability-inclusion-workshop.png',
      '/images/programs/didrr/disability-inclusion-meal.png',
    ],
    status: 'active',
    icon: 'Accessibility',
    color: 'primary.main',
  },
  {
    ...
    galleryImages: [
      '/images/programs/ilp/goat-rearing.png',
      '/images/programs/ilp/poultry-house.png',
    ],
    status: 'active',
    icon: 'Work',
    color: 'warning.main',
  ...
  },
  {
    ...
    heroImage: '/images/programs/education/st-theresa-preschool-1.png',
    galleryImages: [
      '/images/programs/education/st-theresa-preschool-1.png',
      '/images/programs/education/st-theresa-preschool-2.png',
      '/images/programs/education/children-steps-event.png',
    ],
    status: 'ongoing',
    icon: 'School',
    color: 'primary.main',
...
/** General impact/gallery images for homepage or impact section (not project-specific). */
export const generalImpactImages: { src: string; alt: string }[] = [
  ...
  { src: '/images/general/promoting-dignified-lives-oak-caritas.png', alt: 'Oak Foundation and Caritas Mutare project banner' },
  ...
  { src: '/images/general/food-seed-festival-event.png', alt: 'Zimbabwe National Food & Seed Festival with Caritas and Trócaire' },
];

/** Partner and donor logos for "Supported by" / "Our partners" strip (homepage, footer). */
