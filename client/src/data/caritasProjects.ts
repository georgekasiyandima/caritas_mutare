...
export const caritasProjects: CaritasProject[] = [
  ...
  },
  {
    ...
    galleryImages: [
      '/images/programs/didrr/didrr-gallery-01.png',
      '/images/programs/didrr/didrr-gallery-02.png',
    ],
    status: 'active',
    icon: 'Accessibility',
    color: 'primary.main',
  },
  {
    ...
    galleryImages: [
      '/images/programs/ilp/ilp-gallery-01.png',
      '/images/programs/ilp/ilp-gallery-02.png',
    ],
    status: 'active',
    icon: 'Work',
    color: 'warning.main',
