...
export const caritasProjects: CaritasProject[] = [
  {
    ...
    galleryImages: [
      ...
      '/images/programs/serarp/serarp-mechanics-class.png',
  ...
  },
  {
    ...
    galleryImages: [
      ...
      '/images/programs/agriculture/field-green-crops.png',
      '/images/programs/infrastructure/water-bridge-construction.png',
    ],
    status: 'active',
    icon: 'Eco',
    color: 'success.main',
  ...
  },
  {
    ...
    galleryImages: [
      ...
      '/images/programs/soup-kitchen/salad-preparation.png',
      '/images/programs/soup-kitchen/community-gathering-beneficiaries.png',
    ],
    status: 'ongoing',
    icon: 'Restaurant',
    color: 'primary.main',
