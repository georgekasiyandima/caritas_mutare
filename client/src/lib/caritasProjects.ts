...
export const caritasProjects: CaritasProject[] = [
  ...
  },
  {
    ...
    heroImage: '/images/programs/soup-kitchen/soup-kitchen-gallery-07.png',
...
export const generalImpactImages: { src: string; alt: string; objectPosition?: string }[] = [
  ...
  { src: '/images/programs/soup-kitchen/soup-kitchen-gallery-10.png', alt: 'Hot food plated for distribution at the Soup Kitchen', objectPosition: 'center 40%' },
